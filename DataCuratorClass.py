...
class Tool(Descriptor) :
    ...
    def __init__(self,kind = "Software"):
       ...
       if( isinstance(kind, str) ) :
          ...
          if( kind in ["Experiment"] ) :
             Descriptor.__init__(self,["kind","facilityName","measurement","saveas"],["ExpURLs","tags","extras"])
             self.desc["kind"] = kind
          if( kind in ["Software"] ) :
             Descriptor.__init__(self,["kind","packageName","programName","version","saveas"],["URLs","tags","extras"])
             self.desc["kind"] = kind
       else :
    ...
    def addKind(self, kind) :
       if( isinstance(kind, str) ) :
          ...
          print("Cannot add kind, you must provide kind as strings.")
...
class Reference(Descriptor) :
    ...
    def __init__(self,kind = "article"):
       ...
       if( isinstance(kind, str) ) :
          ...
          if( kind in ["article"] ) :
             Descriptor.__init__(self,["kind","DOI","title","authors","journal","page","volume","year","saveas"],["URLs","publishedAbstract","receivedDate","publishedDate","tags","extras"])
             self.desc["kind"] = kind
       else :
...
class Dataset(Descriptor) :
    ...
    #
    def __init__(self):
       Descriptor.__init__(self,["readme","files","saveas"],["URLs","tags","extras"])
    #
    # add readme
    #
...
class Workflows(Descriptor) :
    #
    # constructor
    #
    def __init__(self):
       Descriptor.__init__(self,["edges","nodes"],["tags"])
    
    #
    # add File
    #
    def addEdge(self, Edge) :
       if not "edges" in self.desc :
          self.desc["edges"] = []
    ...
    def addNode(self, Node) :
       if not "nodes" in self.desc :
          self.desc["nodes"] = []
       if Node not in self.desc["nodes"] :
...
class Info(Descriptor) :
    ...
    #
    def __init__(self):
       Descriptor.__init__(self,["pifname","pilname","collections","tags","pi","saveas"],["mainnotebookfile","pimname","extras"])
    #
    ...
    def addName(self, person) :
       if not "pi" in self.desc :
          self.desc["pi"] = []
       if( isinstance(person, Person) ) :
          if( person.isValid() ) :
             self.desc["pi"].append( person.getDesc() )
          else :
    ...
    def addCollection(self, collection) :
       ...
       if ( isinstance(collection,str)):
          self.desc["collections"] =  collection

       else :


          print("Cannot add collection, you must provide collection as string.")    
	#
    # add Collection
    #
    def addTag(self, tag) :
       ...
       if ( isinstance(tag,str)):
          ...
          print("Cannot add tags, you must provide tags as string.")    
    ...
    def __init__(self,kind):
       ...
       if( isinstance(kind, str) ) :
          ...
          if( kind in ["figure","table"] ) :
             Descriptor.__init__(self,["kind","number","caption","properties","files","notebookFile","imageFile","saveas"],["tags","extras"])
             self.desc["kind"] = kind
       else :
...
class Project(Descriptor) :
    ...
    # addReference
    #
    def addWorkflow(self, item) :
       if( isinstance(item, Workflows) ) :
          if( item.isValid() ) :
             self.desc["workflow"] = item.getDesc()
          else :
             sys.exit("Error: item is not valid.")
       else : 
          sys.exit("Error: item must be <Reference>.")
